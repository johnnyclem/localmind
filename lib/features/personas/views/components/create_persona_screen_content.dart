...
class CreatePersonaScreenContent extends ConsumerStatefulWidget {
  final Persona? editPersona;

  const CreatePersonaScreenContent({super.key, this.editPersona});

  @override
  ConsumerState<CreatePersonaScreenContent> createState() =>
      _CreatePersonaScreenContentState();
}

class _CreatePersonaScreenContentState
    extends ConsumerState<CreatePersonaScreenContent> {
