...
class OnboardingServerTypeScreenContent extends ConsumerStatefulWidget {
  const OnboardingServerTypeScreenContent({super.key});

  @override
  ConsumerState<OnboardingServerTypeScreenContent> createState() =>
      _OnboardingServerTypeScreenContentState();
}

class _OnboardingServerTypeScreenContentState
    extends ConsumerState<OnboardingServerTypeScreenContent> {
